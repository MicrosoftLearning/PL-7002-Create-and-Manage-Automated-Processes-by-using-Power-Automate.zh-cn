...
1. 选择在以前的实验室中创建的 **Power Automate SharePoint 网站**。 如果未列出站点，请选择“输入自定义值”并粘贴 Power Automate SharePoint 站点的 URL****
...
1. 选择“**查看详细信息**”，选择“**链接到项**”。
    ...
    ![审批操作步骤的屏幕截图。](../media/start-approval-action.png)
